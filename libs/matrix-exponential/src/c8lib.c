...
/*
  ...
  Input:
    ...
    double complex C, the argument.

  Output:

    double C8_ABS, the function value.
*/
{
  double value;
...
/*
  ...
  Input:
    ...
    double complex C1, the argument.

  Output:

    double complex C8_ACOS, the function value.
*/
{
  double complex c2;
  double c2_imag;
...
/*
  ...
  Output:
    ...
    double complex C8_ACOSH, the function value.
*/
{
  double complex c2;
...
/*
  ...
  Input:
    ...
    double complex C1, C2, the arguments.

  Output:

    double complex C8_ADD, the sum of C1 and C2.
*/
{
  double complex c3;
  double c3_imag;
...
/*
  ...
  Input:
    ...
    double complex C, the complex number.

  Output:

    double C8_ARG, the function value.
*/
{
  double value;
  double x;
...
/*
  ...
  Output:
    ...
    double complex C8_ASIN, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_ASINH, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_ATAN, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_ATANH, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_CONJ, the function value.
*/
{
  double complex c2;
...
/*
  ...
  Input:
    ...
    double complex C2: the value to be copied.

  Output:

    double complex C1, the copy of C2.
*/
{
  c1 = c2;
...
/*
  ...
  Output:
    ...
    double complex C8_COS, the function value.
*/
{
  double complex c2;
...
/*
  ...
  Output:
    ...
    double complex C8_COSH, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_CUBE_ROOT, the function value.
*/
{
  double complex c2;
  double r;
...
/*
  ...
  Output:
    ...
    double complex C8_DIV, the function value.
*/
{
  double c2_norm;
  double complex c3;
...
/*
  ...
  Input:
    ...
    double complex C1, the value to be divided.

    double R, the divisor.

  Output:

    double complex C8_DIV_R8, the function value.
*/
{
  double complex c2;
...
/*
  ...
  Output:
    ...
    double complex C8_EXP, the function value.
*/
{
  double complex c2;
...
/*
  ...
  Output:
    ...
    double complex C8_I, the value of I.
*/
{
  double complex c1;
...
/*
  ...
  Output:
    ...
    double C8_IMAG, the function value.
*/
{
  double value;
...
/*
  ...
  Output:
    ...
    double complex C8_INV, the function value;
*/
{
  double complex c2;
...
/*
  ...
  Input:
    ...
    double complex X, Y, the values to be compared.

  Output:

    int C8_LE_L1, is 1 if X <= Y.
*/
{
  int value;
...
/*
  ...
  Output:
    ...
    double complex C8_LOG, the function value.
*/
{
  double arg;
  double complex c2;
...
/*
  ...
  Output:
    ...
    double C8_MAG, the function value.
*/
{
  double value;
...
/*
  ...
  Output:
    ...
    double complex C8_MUL, the function value.
*/
{
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_NEG, the function value.
*/
{
  double complex c2;
...
/*
  ...
  Input:
    ...
    double complex C1, the value to be NINT'ed.

  Output:

    double complex C8_NINT, the NINT'ed value.
*/
{
  double r;
  double r_min;
...
/*
  ...
  Input:
    ...
    double complex X, the value whose norm is desired.
...
/*
  ...
  Output:
    ...
    double C8_NORM_L2, the 2-norm of X.
*/
{
  double value;
...
/*
  ...
  Output:
    ...
    double C8_NORM_LI, the infinity norm of X.
*/
{
  double value;
...
/*
  ...
  Output:
    ...
    double complex C8_NORMAL_01, a unit pseudonormal value.
*/
{
  const double r8_pi = 3.141592653589793;
  double v1;
...
/*
  ...
  Output:
    ...
    double complex C8_ONE, the value of 1.
*/
{
  double complex c1;
...
/*
  ...
  Input:
    ...
    double complex A, the value to be printed.
...
/*
  ...
  Output:
    ...
    double C8_REAL, the function value.
*/
{
  double value;
...
/*
  ...
  Output:
    ...
    double complex C8_SIN, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_SINH, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_SQRT, the function value.
*/
{
  double complex c2;
  double r;
...
/*
  ...
  Output:
    ...
    double complex C8_SUB, the function value.
*/
{
  double complex c3;
...
/*
  ...
  Input:
    ...
    double complex C1, C2, the values to swap.

  Output:

    double complex C1, C2: the swapped values.
*/
{
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_TAN, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_TANH, the function value.
*/
{
  double complex c2;
  double complex c3;
...
/*
  ...
  Output:
    ...
    double complex C8_UNIFORM_01, a pseudorandom complex value.
*/
{
...
/*
  ...
  Output:
    ...
    double complex C8_ZERO, the value of 0.
*/
{
  double complex c1;
...
/*
  ...
  Input:
    ...
    double complex ALPHA, the first scale factor.

    double complex A[M*N], the first matrix.

    double complex BETA, the second scale factor.

    double complex B[M*N], the second matrix.

  Output:

    double complex C[M*N], the result.
*/
{
  int i;
  int j;
...
/*
  ...
  Input:
    ...
    double ALPHA, the first scale factor.

    double complex A[M*N], the first matrix.

    double BETA, the second scale factor.
...
/*
  ...
  Input:
    ...
    double complex A[M*N], the matrix to be copied.

  Output:

    double complex B[M*N], the copy.
*/
{
  int i;
  int j;
...
/*
  ...
  Input:
    ...
    double complex A1[M*N], the matrix to be copied.

  Output:

    double complex C8MAT_COPY_NEW[M*N], the copy of A1.
*/
{
  double complex *a2;
  int i;
...
/*
  ...
  Input:
    ...
    double complex A[N*N]: the coefficient matrix of the linear system.

    int NB, the number of right hand sides.

    double complex X[N*NB]: the right hand sides.

  Output:

    double complex A[N*N]: A is in unit upper triangular form, and
    represents the U factor of an LU factorization of the
    original coefficient matrix.

    double complex X[N*NB]: the solutions of the linear systems.
*/
{
  int i;
  int ipiv;
...
/*
  ...
  Input:
    ...
    double complex B[N*NB], the right hand sides of the linear systems.
  ...
  Output:
    ...
    double complex C8MAT_FSS_NEW[N*NB], the solutions of the 
    linear systems.
*/
{
  int i;
...
/*
  ...
  Output:
    ...
    double complex C8MAT_IDENTITY_NEW[N*N], the matrix.
*/
{
  double complex *a;
  int i;
...
/*
  ...
  Output:
    ...
    double complex C8MAT_INDICATOR_NEW[M*N], the matrix.
*/
{
  double complex *a;
  int i;
...
/*
  ...
  Input:
    ...
    double complex A[N1*N1], B[N1*N2], the matrices.

  Output:

    double complex C[N1*N2], the result, C = inverse(A) * B.
*/
{
  double complex *alu;
...
/*
  ...
  Output:
    ...
    double complex C8MAT_MINVM_NEW[N1*N2], the result, C = inverse(A) * B.
*/
{
  double complex *alu;
  double complex *c;
...
/*
  ...
  Input:
    ...
    double complex A[N1*N2], double complex B[N2*N3], 
    the matrices to multiply.

  Output:

    double complex C[N1*N3], the product matrix C = A * B.
*/
{
  double complex *c1;
  int i;
...
/*
  ...
  Output:
    ...
    double complex C8MAT_MM_NEW[N1*N3], the product matrix C = A * B.
*/
{
  double complex *c;
  int i;
...
/*
  ...
  Input:
    ...
    double complex A[M*N], the matrix to be NINT'ed.

  Output:

    double complex A[M*N]:the NINT'ed matrix.
*/
{
  int i;
  int j;
...
/*
  ...
  Output:
    ...
    double C8MAT_NORM_FRO, the Frobenius norm of A.
*/
{
  int i;
  int j;
...
/*
  ...
  Input:
    ...
    double complex A[M*N], the matrix whose L1 norm is desired.

  Output:

    double C8MAT_NORM_L1, the L1 norm of A.
*/
{
  double col_sum;
  int i;
...
/*
  ...
  Output:
    ...
    double C8MAT_NORM_LI, the L-infinity norm of A.
*/
{
  int i;
  int j;
...
/*
  ...
  Input:
    ...
    int ILO, JLO, IHI, JHI, the first row and
...
/*
  ...
  Input:
    ...
    double complex ALPHA, the scale factor.

    double complex A[M*N], the matrix to be scaled.

  Output:

    double complex A[M*N]: the scaled matrix.
*/
{
  int i;
  int j;
...
/*
  ...
  Output:
    ...
    double complex C8MAT_UNIFORM_01_NEW[M*N], the pseudorandom  matrix.
*/
{
  double complex *c;
  int i;
...
/*
  ...
  Output:
    ...
    double complex C8MAT_ZERO[M*N], the new zeroed matrix.
*/
{
  double complex *a;
  int i;
...
/*
  ...
  Input:
    ...
    double complex A[N], the vector to be copied.

  Output:

    double complex B[N], the copy.
*/
{
  int i;
...
/*
  ...
  Input:
    ...
    double complex A1[N], the vector to be copied.

  Output:

    double complex C8VEC_COPY_NEW[N], the copy of A1.
*/
{
  double complex *a2;
  int i;
...
/*
  ...
  Output:
    ...
    double complex C8VEC_INDICATOR_NEW[N], the vector.
*/
{
  double complex *a;
  int i;
...
/*
  ...
  Input:
    ...
    double complex A[N], the vector to be nint'ed.

  Output:

    double complex A[N]: the nint'ed vector.
*/
{
  int i;
...
/*
  ...
  Input:
    ...
    double complex A[N], the vector.

  Output:

    double C8VEC_NORM_L1, the norm.
*/
{
  int i;
  double value;
...
/*
  ...
  Input:
    ...
    double complex A[N], the vector to be printed.
...
/*
  ...
  Input:
    ...
    double complex X[N]: an array to be sorted.

  Output:

    double complex X[N]: the sorted array.
*/
{
  int i;
  int indx;
...
/*
  ...
  Input:
    ...
    int N, the number of points on the spiral.

    int M, the number of full circuits the 
    spiral makes.

    double complex C1, C2, the first and last points 
    on the spiral.

  Output:

    double complex C8VEC_SPIRAL_NEW[N], the points.
*/
{
  double complex *c;
  int i;
...
/*
  ...
  Output:
    ...
    double complex C8VEC_UNIFORM_01_NEW[N], the pseudorandom vector.
*/
{
  double complex *c;
  int i;
...
/*
  ...
  Output:
    ...
    double complex C8VEC_UNITY_NEW[N], the N roots of unity.
*/
{
  double complex *a;
  int i;
...
/*
  ...
  Output:
    ...
    double complex CARTESIAN_TO_C8, the complex number.
*/
{
  double complex c;
...
/*
  ...
  Output:
    ...
    double complex POLAR_TO_C8, the complex number.
*/
{
  double complex c;
...
/*
  ...
  Input:
    ...
    double X, the number whose square root is desired.

  Output:

    double complex R8_CSQRT, the square root of X:
*/
{
  double argument;
  double magnitude;
...
/*
  ...
  Input:
    ...
    double A, B, C, the coefficients of the polynomial.
    A must not be zero.

  Output:

    double complex *R1, *R2, the roots of the polynomial, which
...
/*
  ...
  Input:
    ...
    double A, B, C, D, the coefficients of the polynomial.
    A must not be zero.

  Output:

    double complex *R1, *R2, *R3, the roots of the polynomial, which
...
/*
  ...
  Output:
    ...
    double complex *R1, *R2, *R3, *R4, the roots of the polynomial.
*/
{
  double a3;
  double a4;
