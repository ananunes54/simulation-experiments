...
void Shader::setGlmMat3(const char* name, glm::mat3 value)
{
    m_uniforms[name] = value;
}

void Shader::setGlmMat4(const char* name, glm::mat4 value)
{
    m_uniforms[name] = value;
}

void Shader::setGlmVec3(const char* name, glm::vec3 value)
{
    m_uniforms[name] = value;
}

void Shader::setGlmVec4(const char* name, glm::vec4 value)
{
    m_uniforms[name] = value;
}
...
void Shader::bind()
{
    ...
    {
        int uLocation = glGetUniformLocation(m_ID, name);
        switch (value.index()) {
            case 0:
                {
