...
void Physics::buildPoincareGenerator(const glm::vec3& linAcceleration, const glm::vec3& angAcceleration, const glm::vec4& translation)
{
    ...
    {
        m_groupGeneratorMat[4] = Vec5(0.0f);
        m_poincareGroupMat = (m_groupGeneratorMat * m_properTimeInterval).exp();
        m_auxPoincareGroupMat[0] = Vec5(0.0f);
        m_auxPoincareGroupMat[1] = Vec5(0.0f);
        m_auxPoincareGroupMat[2] = Vec5(0.0f);
        m_auxPoincareGroupMat[3] = Vec5(0.0f);
        m_auxPoincareGroupMat[4] = Vec5(translation[0], translation[1], translation[2], translation[3], 0.0f);
